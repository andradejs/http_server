...
int main()
{
    ...
    // static const uint8_t cert_ok[] = TLS_ROOT_CERT_OK; //requisição https
    ...
    while (true)
    {
        ...
        // req1.tls_config = altcp_tls_create_config_client(cert_ok, sizeof(cert_ok)); //requisição https
        int result = http_client_request_sync(cyw43_arch_async_context(), &req1);
        // altcp_tls_free_config(req1.tls_config); //requisição https
